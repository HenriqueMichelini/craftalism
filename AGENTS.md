...
This repository owns ecosystem governance, shared contracts, shared standards, system-level documentation, audit artifacts, and cross-repo architectural guidance for Craftalism.
