...
\begin{itemize}
  \item The dashboard has no application-level authentication or RBAC. Access control is currently provided by the deployment edge rather than by the frontend itself.
